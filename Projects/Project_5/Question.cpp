...
template <class T>
Question<T>::Question(const Question& originalQuestion){
  m_subject = originalQuestion.m_subject;
  m_question = originalQuestion.m_question;
  m_datatype = originalQuestion.m_datatype;
  m_difficulty = originalQuestion.m_difficulty;
  m_isAnswered = originalQuestion.answer;
}
